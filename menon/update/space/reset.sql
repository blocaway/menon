...
INSERT INTO space (id, observation, environment, structure, region, system, matter, quarter_sphere, lat, long, nation, state, space_city, pop, revenue, currency_stock, sector, governance, institution, department, jurisdiction, gini, hdi)
     VALUES (000000000, "Local Supercluster", "Local Group", "Milky Way", "Solar System", "Sun", "Earth", "N", 0, 0, "Gulf of Guinea", "", "", "", "", "", "", "", "", "", "Atlantic", NULL, NULL);

/*** We can force it by doing an INSERT OR REPLACE. ***/
INSERT OR REPLACE INTO space (id, observation, environment, structure, region, system, matter, quarter_sphere, lat, long, nation, state, space_city, pop, revenue, currency_stock, sector, institution, department, jurisdiction, gini, hdi)
     VALUES (000000000, "Local Supercluster", "Local Group", "Milky Way", "Solar System", "Sun", "Earth", "N", 0, 0, "Gulf of Guinea", "", "", "", "", "", "", "", "", "", "Atlantic", NULL, NULL);
